...
public final class Docopt {
   ...
   *
   * @param doc a POSIX-style help message
   * @throws DocoptLanguageError if the help message is malformed
   * @see Docopt
   */
   ...
   * Constructs an argument parser from a POSIX-style help message.
   *
   * @param stream  a stream containing a POSIX-style help message
   ...
   * Constructs an argument parser from a POSIX-style help message.
   *
   * @param stream a UTF-8 encoded stream containing a POSIX-style help message
   * @throws DocoptLanguageError if the help message is malformed
   * @see Docopt
   */
...
// @formatter:off
   ...
   * cause the parser to display the specified string and exit.
   *
   * @param stream  a stream to read containing the version information
   * @param charset the character encoding of {@code stream}
   * @return this object
   */
   ...
   * cause the parser to display the specified string and exit.
   *
   * @param stream a UTF-8 encoded stream to read containing the version
   *               information
   * @return this object
   */
...
// @formatter:off
   ...
   * @throws DocoptExitException if the application should exit and JVM termination has been
  ...
  public Map<String, Object> parse(final List<String> argv)
    ...
    try {
      ...
      @SuppressWarnings("resource") final PrintStream ps = (e.getExitCode() == 0) ? out : err;
